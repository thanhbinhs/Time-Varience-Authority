                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Container(
                                    width: 60,
                                    // color: Colors.yellow,
                                    child: Icon(Icons.supervised_user_circle,size: 40,color: Colors.white,),
                                  ),
                                ...
                                child:  Stack(
                                  children: [
                                    ...
                                    AnimatedPositioned(
                                      ...
                                      duration: Duration(milliseconds: 200), // Sửa từ microseconds thành milliseconds
                                      child: Container(
                                        height: variableData.screenHeight() * 0.07,
                                        width: 100,
                                        decoration: BoxDecoration(
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          width: 60,
                                          // color: Colors.yellow,
                                          child: Icon(Icons.key,size: 30,color: Colors.white,),
                                        ),
                                      ],
                                    ),
                                  ],
