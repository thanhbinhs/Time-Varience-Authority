...
import '../Widgets/Routine/ListTaskWidget/MainTaskWidget_v2.dart';
import 'package:intl/intl.dart';
import '../Widgets/Routine/VariablesDataRoutineClass.dart';
    ...
    return Container(
      ...
      child: Stack(
        ...
        children: [
          ...
          MainTaskWidget(dayIsPressed: dayIsPressed,)
          // TaskWidget(),
        ],
      ),
          AddNewTaskPageWidget(dayIsPressed: dayIsPressed,),
        ],
      ),
    );
  }
